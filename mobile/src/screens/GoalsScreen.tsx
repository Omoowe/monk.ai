...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 11, color: '#aaa', fontFamily: 'DMMono_400Regular' },
  addBtn: { borderWidth: 1, borderColor: '#b8f058', borderRadius: 8, paddingHorizontal: 14, paddingVertical: 9 },
  addBtnText: { color: '#b8f058', fontSize: 13, fontWeight: '700' },
  ...
  completeBadgeText: { fontSize: 9, color: '#b8f058', fontFamily: 'DMMono_400Regular', letterSpacing: 1 },
  goalTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  catBadge: {
    borderRadius: 6, borderWidth: 1,
    paddingHorizontal: 8, paddingVertical: 3,
  },
  catLabel: { fontSize: 9, letterSpacing: 2, fontFamily: 'DMMono_400Regular', fontWeight: '700' },
  deleteBtn: { color: '#555', fontSize: 16 },
  goalName: { fontSize: 17, fontWeight: '700', color: '#fff' },
  editHint: { fontSize: 11, color: '#444' },
  goalTarget: { fontSize: 12, color: '#aaa', fontFamily: 'DMMono_400Regular', marginBottom: 12 },
  ...
  progressPct: { fontSize: 12, fontFamily: 'DMMono_400Regular', fontWeight: '700', width: 36 },
  progressPctInput: {
    fontSize: 12, fontFamily: 'DMMono_400Regular', fontWeight: '700',
  ...
  deadline: { flex: 1, fontSize: 11, color: '#aaa', fontFamily: 'DMMono_400Regular' },
  adviceBtn: {
    flex: 1,
  ...
  adviceBtnText: { fontSize: 13, color: '#b8f058', fontWeight: '700' },

  stalledText: { fontSize: 11, color: '#f06060', fontFamily: 'DMMono_400Regular', marginTop: 10, letterSpacing: 1 },
  ...
  filterChipText: { fontSize: 10, color: '#aaa', fontFamily: 'DMMono_400Regular', letterSpacing: 1 },
  filterChipCount: { fontSize: 10, color: '#666', fontFamily: 'DMMono_400Regular' },
  milestoneBox: {
  ...
  milestoneBoxLabel: { fontSize: 11, letterSpacing: 1.5, color: '#b8f058', fontFamily: 'DMMono_400Regular', fontWeight: '700' },
  milestoneBoxText: { fontSize: 13, color: '#ccc', lineHeight: 20 },
  ...
  adviceBoxLabel: { fontSize: 11, letterSpacing: 1.5, fontFamily: 'DMMono_400Regular', fontWeight: '700' },
  adviceClose: { fontSize: 13, color: '#aaa' },
  adviceText: { fontSize: 13, color: '#bbb', lineHeight: 20 },
  ...
  emptyTitle: { fontSize: 18, color: '#fff', fontWeight: '700', fontFamily: 'Syne_800ExtraBold' },
  ...
  modalTitle: { fontSize: 20, fontWeight: '800', color: '#fff', fontFamily: 'Syne_800ExtraBold', marginBottom: 16 },
  formFieldLabel: { fontSize: 9, letterSpacing: 2, color: '#aaa', fontFamily: 'DMMono_400Regular', marginBottom: -4 },
  addErrorText: { color: '#f06060', fontSize: 12, backgroundColor: '#f0606015', borderRadius: 6, padding: 10, borderWidth: 1, borderColor: '#f0606030' },
  input: { backgroundColor: '#111', borderRadius: 8, borderWidth: 1, borderColor: '#333', padding: 12, color: '#fff', fontSize: 15 },
  ...
  catChipText: { fontSize: 10, letterSpacing: 1, color: '#aaa', fontFamily: 'DMMono_400Regular' },
  ...
  editDeadlineLabel: { flex: 1, fontSize: 9, color: '#999', fontFamily: 'DMMono_400Regular', letterSpacing: 1 },
  editDeadlineVal: { fontSize: 14, color: '#fff', fontFamily: 'DMMono_400Regular', minWidth: 56, textAlign: 'center' },
  editStepBtn: {
    width: 44, height: 44, borderRadius: 8,
    backgroundColor: '#2a2a2a', alignItems: 'center', justifyContent: 'center',
  },
  editStepBtnText: { fontSize: 18, color: '#b8f058', lineHeight: 20 },
});
