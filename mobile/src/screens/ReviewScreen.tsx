...
const styles = StyleSheet.create({
  ...
  goalRow: { gap: 6 },
  goalName: { fontSize: fscale(13), color: '#aaaaaa', fontWeight: '600' },
  ...
  reviewText: { fontSize: fscale(15), color: '#aaaaaa', lineHeight: 26 },
  ...
  historyDate: { fontSize: fscale(13), color: '#aaaaaa', fontFamily: 'DMMono_400Regular' },
  historyChevron: { fontSize: fscale(10), color: '#aaa' },
  historyStats: { flexDirection: 'row', gap: 8, marginTop: 10 },
  historyStatPill: {
    flex: 1, backgroundColor: '#181818', borderRadius: 8, paddingVertical: 8,
