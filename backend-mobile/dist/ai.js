...
function getPersonalityVoice(p) {
    const map = {
...
function buildForcedReferenceInstruction(ctx) {
    const lines = [];
...
function buildSystemPrompt(personality, ctx) {
...
// ─── Chat message ─────────────────────────────────────────────────────────
export async function askCoach(userMessage, personality, ctx) {
...
// ─── Morning activation ───────────────────────────────────────────────────
export async function generateMorningBrief(personality, ctx, mission, energy, distraction) {
...
// ─── Evening debrief ──────────────────────────────────────────────────────
export async function generateEveningFeedback(personality, ctx, mission, completed, reason, completedHabits, totalHabits) {
    const system = `${getPersonalityVoice(personality)}
...
// ─── Pep talk ─────────────────────────────────────────────────────────────
export async function getPepTalk(personality, ctx) {
...
// ─── Goal advice ──────────────────────────────────────────────────────────
export async function getGoalAdvice(personality, ctx, goalName, progress, daysSince) {
    const system = `${getPersonalityVoice(personality)}
...
// ─── Weekly review ────────────────────────────────────────────────────────
export async function generateWeeklyReview(personality, ctx, weekTotal, weekMax, failedMissionReasons, stalledGoals) {
